...
import WhitelistStats from "./WhitelistStats";
      ...
      <main className="flex justify-center">
        ...
        <div className="w-full lg:w-4/5 xl:w-3/5 h-full">
          ...
          <p className="text-lg md:text-2xl text-center md:pb-12">
            If you ugly enough, maybe you will get Golden Snout!
          </p>
          ...
          <div className="flex flex-col md:flex-row justify-around">
            ...
            <WhitelistStats 
              maxWhitelistSpots={maxWhitelistSpots} 
              maxPublicSpots={String(maxPublicSpots)}
              maxOwnerSpots={String(maxOwnerSpots)}
              takenPublicSpots={takenPublicSpots}
              takenOwnerSpots={takenOwnerSpots}
            />
